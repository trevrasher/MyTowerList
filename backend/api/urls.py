...
from .views import GetAllTowersByScore, GetTowerByName, GetGameBadgesCSV, SyncTowerCompletions, GetCompletedTowers, GetEligibleAreas, TowerListView
urlpatterns = [
    ...
    path('api/towers/', TowerListView.as_view(), name='tower-list'),
